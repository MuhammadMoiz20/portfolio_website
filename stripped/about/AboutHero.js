...
function AboutHero() {
  return React.createElement(
    ...
    {
      className:
        "relative py-24 bg-gradient-to-b from-primary-50 to-white dark:from-gray-900 dark:to-gray-800",
    },
    React.createElement(
      "div",
      {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            {
              className:
                "relative h-96 w-full lg:h-[500px] overflow-hidden rounded-lg shadow-xl",
            },
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                {
                  className:
                    "inline-block px-4 py-1 rounded-full bg-primary-500 text-sm font-medium text-white mb-2",
                },
                "Dartmouth College",
              ),
              React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                {
                  className:
                    "rounded-full bg-primary-100 p-3 inline-flex text-primary-600 dark:bg-primary-900 dark:text-primary-400 mb-3",
                },
          ...
          React.createElement(
            ...
            {
              className:
                "mt-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border-l-4 border-primary-500",
            },
            React.createElement(
              "p",
              {

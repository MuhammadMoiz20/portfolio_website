...
/**
 * ProjectsGrid component displays a grid of project cards
 * Can optionally show a title, description, and filter projects by tag
 */
export default function ProjectsGrid({ 
  ...
  // Filter projects by tag if a filteredTag is provided

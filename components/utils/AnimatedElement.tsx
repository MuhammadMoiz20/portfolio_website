...
interface AnimatedElementProps {
  ...
  /**
   * Whether the animation should only play once when in view
   * @default true
   */
  once?: boolean;
  
  /**
   * Custom variants for advanced animation control
   */
 ...
 * A reusable wrapper that applies animation to its children using Framer Motion
 */

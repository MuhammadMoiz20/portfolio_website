...
interface SkillBarProps {
  ...
  /**
   * Whether to animate the bar on scroll
   * @default true
   */
  animate?: boolean;
...
/**
 * SkillBar component
 * Displays a skill with a progress bar indicating proficiency level
 */
export default function SkillBar({
  ...
  // Get gradient class if variant is gradient

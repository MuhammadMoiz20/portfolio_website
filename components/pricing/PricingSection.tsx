...
interface PricingSectionProps {
  ...
  /**
   * Show a comparison table below pricing cards
   * @default false
   */
  showComparisonTable?: boolean;
  
  /**
   * Include a money-back guarantee notice
   * @default true
   */
 ...
 * Displays pricing plans for services or products
 */
export default function PricingSection({
  ...
  const calculatePrice = (plan: PricingPlan) => {
    if (typeof plan.price === 'string') {
      return plan.price; // Custom text like "Contact us"
    }
  ...
  /**
   * Calculate original price (for plans with discounts)
   */
  ...
  /**
   * Show tooltip for a specific feature
   */
  ...
  return (
    <section className={`py-16 ${className}`}>
      <div className="container mx-auto px-4">
        ...
        {/* Comparison table (shown on smaller plans) */}
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 rounded-lg dark:divide-gray-700">
                ...
                <tbody className="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                  {/* Create rows based on all unique features */}

...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', url: 'https://www.moizofficial.com/blog', title: 'Blog' },
  ...
  return (
    <div className="pt-20">
      ...
      <div className="container-custom grid gap-6 pb-16 md:grid-cols-2">
        {posts.map((post) => (
          <a key={post.slug} href={`/blog/${post.slug}`} className="group rounded-lg border p-5 transition-colors hover:bg-muted">
            ...
            <div className="mt-3 text-xs text-muted-foreground">
              {new Date(post.date).toLocaleDateString()} • {post.readingTimeMinutes} min
            </div>
          </a>
        ))}
      </div>

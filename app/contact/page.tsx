            ...
            <div className="grid gap-10 lg:grid-cols-2">
              ...
              >
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    href="https://twitter.com/zahid_moiz"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="mt-10 rounded-lg bg-gray-50 p-6 dark:bg-gray-800">
                  ...
                  <p className="mb-2 text-gray-600 dark:text-gray-400">Monday - Friday: 9am - 5pm EST</p>
                  <p className="text-gray-600 dark:text-gray-400">Weekend: Available for urgent matters</p>
                </div>
              </motion.div>
